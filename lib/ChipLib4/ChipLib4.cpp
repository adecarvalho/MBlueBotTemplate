...
//-----------------------
//-----------------------
DigitalIn::DigitalIn(uint8_t pin) : myPin(pin)
{
  this->myValue = 0;
}
//--------------------------------
...
//-----------------------------
//-----------------------------
AnalogIn::AnalogIn(uint8_t pin) : myIn(pin)
{
  this->myVal = 0;
}
//--------------------------------
...
//------------------------------
//------------------------------
AnalogOut::AnalogOut(uint8_t pinSS, uint8_t pinLdac, uint8_t clock_div) : mySSPin(pinSS), myLDACPin(pinLdac), myClockDiv(clock_div)
{
  this->myValue = 0;
}
//-------------------------------
...
//-----------------------------
//------------------------------
ButtonIn::ButtonIn(uint8_t pin, uint8_t pull) : myPin(pin), myPull(pull)
{
...
// Note for sound
//--------------------------------------------------------------
Note::Note(char _note, bool _isSharp, char _octave, int _duration) : myNoteChar(_note), myIsSharp(_isSharp), myOctave(_octave), myDuration(_duration)
{

  myFrequency = calculateFreq();
}
//-------------------------------------
Note::Note(const char *_str, int _duration) : myDuration(_duration)
{
...
//-------------------------------------
Buzzer::Buzzer(char _pin) : myPin(_pin)
{
