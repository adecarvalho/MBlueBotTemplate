...
MePort_Sig mePort[11] =
    {
        {NC, NC}, {11, 12}, {9, 10}, {A2, A3}, {A0, A1}, {NC, NC}, {8, A6}, {A7, 13}, {8, A6}, {6, 7}, {5, 4}};
...
//******************************
float MBlueUltrasonic::getDistanceCm()
{
  return MBlueUltrasonic::getDistance(100);
}
//*********************************
float MBlueUltrasonic::getDistance(uint16_t maxCm)
{
